...
enclave can answer queries on behalf of the requested domain name, and issues a
certificate to the enclave (step~\ding{204}).
...
Makefile,\footnote{The source code is publicly available but we redacted the URL
to remain anonymous.} i.e.:
