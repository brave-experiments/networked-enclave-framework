...
concrete hardware and software implementation remains confidential.
Amazon's decision to allocate physically separate resources to enclaves appears
promising, but the coming years will tell if the implementation can resist the types
of attacks that have been plaguing SGX.  If we assume that Nitro enclaves are
