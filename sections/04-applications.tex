...
\phw{Find citations to highlight the importance of oblivious IP address
processing.}
...
\phw{Rephrase the above, and provide alternatives.  Reviewers are almost
certainly going to tear this apart.}
...
\phw{Add more details about how the shuffling is done.}
